    ...
    <div className="w-full">
      ...
      <div className="mt-4 space-y-2">
        ...
        <div className="text-center text-sm text-black">
          {filters.viewMode === 'segment-mode'
            ? `Showing contribution breakdown by segments from ${yearToMonth(filters.yearRange[0])} to ${yearToMonth(filters.yearRange[1])}`
            : `Showing contribution breakdown by geographies from ${yearToMonth(filters.yearRange[0])} to ${yearToMonth(filters.yearRange[1])}`
          }
        </div>
